...
export function IconShiftInfo({ size = 14 }: IconProps) {
  return (
...
export function IconMonitoring({ size = 14 }: IconProps) {
  return (
    <svg {...base(size)} aria-hidden="true">
...
export function IconFindings({ size = 14 }: IconProps) {
  return (
    <svg {...base(size)} aria-hidden="true">
...
export function IconTasks({ size = 14 }: IconProps) {
  return (
    <svg {...base(size)} aria-hidden="true">
